...
namespace SQL
{
    ...
    public class SQLiteHelper
    {
        ...
        private SQLiteCommand CreateProcCommand(string procName, SQLiteParameter[] prams)
        {
            ...
            sQLiteParameter.ParameterName = RETURNVALUE;
            sQLiteParameter.DbType = DbType.Int32;
            sQLiteParameter.Size = 4;
            sQLiteParameter.IsNullable = false;
            sQLiteParameter.SourceColumn = string.Empty;
        ...
        private SQLiteDataAdapter CreateProcDataAdapter(string procName, SQLiteParameter[] prams)
        {
            ...
            da.SelectCommand.Parameters.Add(sQLiteParameter);
        ...
        private SQLiteDataAdapter CreateSQLiteDataAdapter(string cmdText, SQLiteParameter[] prams)
        {
            ...
            ///添加返回参数ReturnValue
            //SQLiteParameter sqliteParam = new SQLiteParameter(RETURNVALUE, DbType.Int32, 4,
