...
{
    public partial class GeoMapLabelLvZuqian : System.Web.UI.Page
    {
        public DataTable dt;
       ...
       protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sql+=" (b.c_deathyear>=907 and  b.c_birthyear<=1200) and c.x_coord is not null and c.y_coord is not null";
            //sql += "c.x_coord is not null and c.y_coord is not null";
